...
const InstitutionResults = ({ selectedInstitution }) => {
  ...
  const fertilityBenefitsMessage = hasFertilityBenefits 
    ...
    let electiveTreatmentCoveredMessage = "Unknown";
    if (isElectiveTreatmentCovered == 1) {
      electiveTreatmentCoveredMessage = "Yes";
    } else if (isElectiveTreatmentCovered == 0) {
      electiveTreatmentCoveredMessage = "No";
    }
      ...
      <section>
        ...
        <div className="row">
          <div className="col-md-6">
            {hasValue(selectedInstitution.maternal_leave_paid_weeks) && (
          ...
          <div className="col-md-6">
            {hasValue(selectedInstitution.paternal_leave_paid_weeks) && (
              <div className="leave-info">
        ...
        {!hasValue(selectedInstitution.maternal_leave_paid_weeks) && !hasValue(selectedInstitution.paternal_leave_paid_weeks) && (
